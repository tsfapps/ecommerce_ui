 ...
 */
public class PackagingFrag extends Fragment implements VideloAdapter.OnItmCickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.pack_frag, container, false);
    }
    ...
    public void packagingShow (){

        Api api = ApiClient.getApiClient().create(Api.class);
        Call<List<VideloModel>> listCall = api.getPackaging();
        ...
        listCall.enqueue(new Callback<List<VideloModel>>() {
            ...
            public void onResponse(Call<List<VideloModel>> call, Response<List<VideloModel>> response) {
                ...
                videloAdapter.setOnItmClkListener(PackagingFrag.this);
            }
