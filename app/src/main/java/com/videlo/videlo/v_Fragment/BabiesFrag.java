 ...
 */
public class BabiesFrag extends Fragment implements VideloAdapter.OnItmCickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.baby_frag, container, false);
    }
    ...
    public void babies() {
        ...
        listCall.enqueue(new Callback<List<VideloModel>>() {
            ...
            public void onResponse(Call<List<VideloModel>> call, Response<List<VideloModel>> response) {
                ...
                videloAdapter.setOnItmClkListener(BabiesFrag.this);
            }
