 ...
 */
public class ConsumerFrag extends Fragment implements VideloAdapter.OnItmCickListener {
    ...
    public void consumer (){
        ...
        Call<List<VideloModel>> listCall = api.getConsumer();
        ...
        listCall.enqueue(new Callback<List<VideloModel>>() {
            ...
            public void onResponse(Call<List<VideloModel>> call, Response<List<VideloModel>> response) {
                ...
                videloAdapter.setOnItmClkListener(ConsumerFrag.this);
            }
