 ...
 */
public class MenFrag extends Fragment implements VideloAdapter.OnItmCickListener {
    ...
    public void menShow (){
        ...
        Call<List<VideloModel>> listCall = api.getMen();
        ...
        listCall.enqueue(new Callback<List<VideloModel>>() {
            ...
            public void onResponse(Call<List<VideloModel>> call, Response<List<VideloModel>> response) {
                ...
                videloAdapter.setOnItmClkListener(MenFrag.this);
            }
