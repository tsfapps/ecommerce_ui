 ...
 */
public class OfficeFrag extends Fragment implements VideloAdapter.OnItmCickListener {
    ...
    public void officeFrag (){

        Api api = ApiClient.getApiClient().create(Api.class);
        Call<List<VideloModel>> listCall = api.getOffice();
        ...
        listCall.enqueue(new Callback<List<VideloModel>>() {
            ...
            public void onResponse(Call<List<VideloModel>> call, Response<List<VideloModel>> response) {
                ...
                videloAdapter.setOnItmClkListener(OfficeFrag.this);
            }
