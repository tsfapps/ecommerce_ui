 ...
 */
public class WomenFrag extends Fragment implements VideloAdapter.OnItmCickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.women_frag, container, false);
    }
    ...
    public void womenDetails (){
        ...
        listCall.enqueue(new Callback<List<VideloModel>>() {
            ...
            public void onResponse(Call<List<VideloModel>> call, Response<List<VideloModel>> response) {
                ...
                videloAdapter.setOnItmClkListener(WomenFrag.this);
            }
