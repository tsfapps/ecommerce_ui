 ...
 */
public class ComputersFrag extends Fragment implements VideloAdapter.OnItmCickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.computer_frag, container, false);
    }
    ...
    public void computer (){
        ...
        listCall.enqueue(new Callback<List<VideloModel>>() {
            ...
            public void onResponse(Call<List<VideloModel>> call, Response<List<VideloModel>> response) {
                ...
                videloAdapter.setOnItmClkListener(ComputersFrag.this);
            }
