 ...
 */
public class BagsFrag extends Fragment implements VideloAdapter.OnItmCickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.bags_frag, container, false);
    }
    ...
    public void bags (){
        ...
        listCall.enqueue(new Callback<List<VideloModel>>() {
            ...
            public void onResponse(Call<List<VideloModel>> call, Response<List<VideloModel>> response) {
                ...
                videloAdapter.setOnItmClkListener(BagsFrag.this);
            }
