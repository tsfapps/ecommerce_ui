 ...
 */
public class MachineryFrag extends Fragment implements VideloAdapter.OnItmCickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.machine_frag, container, false);
    }
    ...
    public void machineShow() {
        ...
        listCall.enqueue(new Callback<List<VideloModel>>() {
            ...
            public void onResponse(Call<List<VideloModel>> call, Response<List<VideloModel>> response) {
                ...
                videloAdapter.setOnItmClkListener(MachineryFrag.this);
            }
