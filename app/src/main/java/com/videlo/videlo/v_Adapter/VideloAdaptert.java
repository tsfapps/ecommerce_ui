...
public class VideloAdaptert extends RecyclerView.Adapter<VideloAdaptert.MyViewHolder> {
    ...
    public VideloAdaptert(Context context, List<VideloModel> videloModels) {
    ...
    @NonNull
    @Override
    public VideloAdaptert.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.model_maint,viewGroup,false);

        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull VideloAdaptert.MyViewHolder myViewHolder, int i) {
